...
const PlatformCard = ({ platform, device }) => {
  ...
  return (
    <div
      className={`bg-white rounded-xl border border-gray-200 hover:border-${config.color}-300 transition-all duration-200 ${isMobile ? "p-4" : "p-6"}`}
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          <div
            className={`w-12 h-12 rounded-lg bg-${config.color}-100 flex items-center justify-center text-xl`}
          >
            {config.icon}
          </div>
          <div>
            <h3
              className={`font-bold capitalize ${isMobile ? "text-lg" : "text-xl"} text-gray-900`}
            >
              {platform.platform}
            </h3>
        ...
        <div className="text-right">
          <div
            className={`font-bold ${isMobile ? "text-xl" : "text-2xl"} text-${config.color}-600`}
          >
      ...
      {!isMobile && (
        <div className="mt-4 flex space-x-2">
          <button
            className={`flex-1 px-3 py-2 bg-${config.color}-100 text-${config.color}-700 rounded-lg text-sm font-medium hover:bg-${config.color}-200 transition-colors`}
          >
            View Details
          </button>
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h4
              className={`font-medium ${isMobile ? "text-sm" : "text-base"} text-gray-900`}
            >
...
const KeywordsLanguagesTab = ({ device, multilingualStats }) => {
  ...
  const keywordCategories = [
    ...
    {
      name: "Tier 2 High Priority",
      count: 78,
      examples: ["polar bear", "african lion", "shark fin", "coral red"],
    },
    {
      name: "Marine Species",
      count: 65,
    ...
    },
    {
      ...
      count: 156,
      examples: ["ivory carving", "fur coat", "bone jewelry", "horn powder"],
    },
    {
      name: "Scientific Names",
      count: 67,
      examples: ["loxodonta africana", "panthera tigris", "diceros bicornis"],
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-purple-700">
                Expert-curated keywords across {languagesDetected} languages
              </p>
            </div>
          </div>
          <div className="text-right">
        ...
        <div
          className={`grid ${isMobile ? "grid-cols-2 gap-4" : "grid-cols-4 gap-6"}`}
        >
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div
          className={`grid ${isMobile ? "grid-cols-1 gap-3" : "grid-cols-2 lg:grid-cols-3 gap-4"}`}
        >
            ...
            >
              ...
              <div className="text-xs text-gray-500 space-y-1">
                {category.examples.map((example, i) => (
                  <div
                    key={i}
                    className="bg-gray-100 rounded px-2 py-1 inline-block mr-1 mb-1"
                  >
                    {example}
                  </div>
                ))}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div
          className={`grid ${isMobile ? "grid-cols-1 gap-4" : "grid-cols-2 lg:grid-cols-4 gap-6"}`}
        >
            ...
            return (
              ...
              >
                <div className="flex items-center space-x-4">
                  <div
                    className={`w-10 h-10 rounded-lg bg-${config.color}-100 flex items-center justify-center text-lg`}
                  >
                    {config.icon}
                  </div>
                  <div>
...
const EnhancedDashboard = ({ onLogout }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      name: "Platforms",
      icon: Globe,
      description: "7 marketplace coverage",
    },
    {
      id: "keywords",
      name: "Keywords & Languages",
      icon: Languages,
      description: "1,452 multilingual terms",
    },
    {
      id: "analytics",
      name: "Analytics & Reports",
      icon: BarChart3,
      description: "Government-grade intelligence",
    },
    {
      id: "alerts",
      name: "Threat Alerts",
      icon: AlertTriangle,
      description: "High-priority detections",
    },
    {
      id: "system",
      name: "System Status",
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      ...
      case "platforms":
        return (
          <PlatformsTab device={device} platformActivity={platformActivity} />
        );
      case "keywords":
        return (
          <KeywordsLanguagesTab
            device={device}
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-medium text-gray-900">
            Loading WildGuard AI Dashboard...
          </p>
          <p className="text-gray-500">
            Connecting to wildlife protection network
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Navigation */}
          <nav
            className={`${isMobile ? "overflow-x-auto" : "flex space-x-8"} -mb-px`}
          >
            <div
              className={`flex ${isMobile ? "space-x-4 pb-2" : "space-x-8"}`}
            >
              {navigation.map((item) => {
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          >
            <div
              className={`flex ${isMobile ? "flex-col space-y-1" : "items-center space-x-8"}`}
            >
              <div className="flex items-center space-x-2">
                <Shield className="w-5 h-5" />
                <span className="font-medium">
                  {realTimeStats.totalDetections?.toLocaleString() || "0"} Total
                  Detections
                </span>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium">
                  {realTimeStats.highPriorityAlerts || "0"} High-Priority
                  Threats
                </span>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium">
                  {realTimeStats.platformsMonitored || "7"} Platforms • 16
                  Languages
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  ...
                  <div className="font-bold">
                    {realTimeStats.todayDetections?.toLocaleString() || "0"} New
                    Detections
                  </div>
                </div>
                <button
          ...
          >
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Advanced AI-powered wildlife trafficking detection platform.
                Real-time monitoring across 7 international marketplaces with
                1,452 multilingual keywords in 16 languages.
              </p>
            </div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-blue-600">
                    {platformActivity
                      .find((p) => p.platform === "ebay")
                      ?.totalDetections?.toLocaleString() || "Active"}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Total Platforms:</span>
                  <span className="text-green-600">
                    {realTimeStats.platformsMonitored || "7"} Active
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 space-y-2">
                ...
                <p className="text-xs mt-4 text-gray-500">
                  © 2025 WildGuard AI. Protecting wildlife through intelligent
                  technology.
                </p>
              </div>
            </div>
...
const DashboardTab = ({ device, realTimeStats, recentAlerts }) => {
  ...
  return (
    <div className="space-y-8">
      {/* Quick Stats */}
      <div
        className={`grid ${isMobile ? "grid-cols-2 gap-4" : "grid-cols-2 lg:grid-cols-4 gap-6"}`}
      >
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div
          className={`grid ${isMobile ? "grid-cols-1 gap-4" : "grid-cols-2 lg:grid-cols-3 gap-6"}`}
        >
          {platformActivity.map((platform, index) => (
