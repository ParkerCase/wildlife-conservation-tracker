...
# Extend with all categories
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(TIER_1_CRITICAL_SPECIES)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(TIER_2_HIGH_PRIORITY_SPECIES)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(TIER_3_MEDIUM_PRIORITY_SPECIES)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(MARINE_SPECIES_KEYWORDS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(BIRD_SPECIES_KEYWORDS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(PLANT_SPECIES_KEYWORDS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(TRADITIONAL_MEDICINE_KEYWORDS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(TRAFFICKING_CODE_WORDS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(PRODUCT_COMBINATIONS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(GEOGRAPHIC_INDICATORS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(SCIENTIFIC_NAMES)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(JEWELRY_ACCESSORY_TERMS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(LUXURY_FASHION_TERMS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(ANTIQUE_COLLECTIBLE_TERMS)
ALL_ENDANGERED_SPECIES_KEYWORDS.extend(ONLINE_MARKETPLACE_TERMS)
