#!/usr/bin/env python3
"""
Minimal WildGuard AI Backend - Port 5001 (macOS AirPlay fix)
Run this to avoid port 5000 conflicts with AirPlay Receiver
"""
...
# Enable CORS for all domains and all routes - UPDATED for port 5001
CORS(
    app,
    ...
    return jsonify(
        {
            ...
            "message": "CORS should be working now! (Port 5001 to avoid AirPlay)",
        }
    )
...
if __name__ == "__main__":
    print("🚀 Starting Minimal WildGuard AI Backend (Port 5001)...")
    print("=" * 60)
    print("🌐 Server: http://localhost:5001")
    print("🏥 Health: http://localhost:5001/health")
    print("📊 Stats: http://localhost:5001/api/stats/realtime")
    print("🔧 CORS: Configured for localhost:3000")
    print("💡 Using port 5001 to avoid macOS AirPlay conflicts")
    print("=" * 60)
